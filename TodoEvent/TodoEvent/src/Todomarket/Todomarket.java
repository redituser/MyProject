...
public class Todomarket {
	...
	public static void main(String[] args) {
		...
		// 임의 물품 설정
		Iteminfo iteminfo1 = new Iteminfo(1, "노트");
		Iteminfo iteminfo2 = new Iteminfo(2, "텀블러");
		Iteminfo iteminfo3 = new Iteminfo(3, "키보드");
		...
		TodoController controller = new TodoController(list, marketList, view);
		controller.start();
